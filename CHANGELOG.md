...
* fix(deps): require matching filament-analytics-core major (1.x) by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-fathom/pull/36

**Full Changelog**: https://github.com/jeffersongoncalves/filament-fathom/compare/1.3.0...1.3.1
