...
* docs: add Buy Me a Coffee sponsor link by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-fathom/pull/18
* chore: add Buy Me a Coffee to FUNDING.yml by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-fathom/pull/21
* ci: standardize update-changelog workflow (2.x) by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-fathom/pull/24
* build(deps): bump the composer-deps group with 2 updates by @dependabot[bot] in https://github.com/jeffersongoncalves/filament-fathom/pull/30
* build(deps): bump the actions-deps group with 2 updates by @dependabot[bot] in https://github.com/jeffersongoncalves/filament-fathom/pull/29
* feat(i18n): add translations (2.x) by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-fathom/pull/34

**Full Changelog**: https://github.com/jeffersongoncalves/filament-fathom/compare/2.2.0...2.3.0
