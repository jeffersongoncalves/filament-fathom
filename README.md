...
![Filament Fathom](https://raw.githubusercontent.com/jeffersongoncalves/filament-fathom/1.x/art/jeffersongoncalves-filament-fathom.jpg)
...
```bash
composer require jeffersongoncalves/filament-fathom:"^1.0"
```
